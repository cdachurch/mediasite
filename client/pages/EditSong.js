          ...
          <div className="card-content">
            ...
            <form className="col s12" onSubmit={this.handleFormSubmit.bind(this)}>
              <SongField
                ...
                handleOnChange={event => this.handleFormChange(event, 'title')}
                labelText="Title"
              />
              <SongField
                fieldId="author1"
                fieldValue={this.state.author1}
                handleOnChange={event => this.handleFormChange(event, 'author1')}
                labelText="Author #1"
              />
              <SongField
                fieldId="author2"
                fieldValue={this.state.author2}
                handleOnChange={event => this.handleFormChange(event, 'author2')}
                labelText="Author #2"
              />
              <SongField
                fieldId="style"
                fieldValue={this.state.style}
                handleOnChange={event => this.handleFormChange(event, 'style')}
                labelText="Style"
              />
              <MaterializeSelect
              ...
              <SongField
                fieldId="ccli"
                fieldValue={this.state.ccli}
                handleOnChange={event => this.handleFormChange(event, 'ccli')}
                labelText="CCLI #"
              />
              <SongField
                fieldId="copyDate"
                fieldValue={this.state.copyDate}
                handleOnChange={event => this.handleFormChange(event, 'copyDate')}
                labelText="Copyright Date"
              />
              <SongField
                fieldId="youtubeLink"
                fieldValue={this.state.youtubeLink}
                handleOnChange={event => this.handleFormChange(event, 'youtubeLink')}
                labelText="YouTube Link"
              />
              <SongField
                fieldId="publisher"
                fieldValue={this.state.publisher}
                handleOnChange={event => this.handleFormChange(event, 'publisher')}
                labelText="Publisher"
              />
              <SongField
                fieldId="songOrder"
                fieldValue={this.state.songOrder}
                handleOnChange={event => this.handleFormChange(event, 'songOrder')}
                labelText="Song Order/Arrangement"
              />
              <SongField
                fieldId="externalUrl"
                fieldValue={this.state.externalUrl}
                handleOnChange={event => this.handleFormChange(event, 'externalUrl')}
                labelText="External URL"
              />
              <SongField
                fieldId="notes"
                fieldValue={this.state.notes}
                handleOnChange={event => this.handleFormChange(event, 'notes')}
                labelText="Notes"
              />
        ...
        <div className="card">
          <div className="card-content">
            ...
            <form onSubmit={this.handleFormSubmit.bind(this)}>
              <SongPartCreator
                songParts={this.state.songPartData.parts || []}
                ref={input => (this.songPartData = input)}
              />
              <input className="btn" type="submit" />
              {cancelButton}
            </form>
