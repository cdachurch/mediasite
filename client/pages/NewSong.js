            ...
            >
              ...
              <div className="input-field col s12">
                <input
                  ...
                  type="text"
                  className="validate"
                  value={this.state.author1}
                  onChange={event => this.handleFormChange(event, "author1")}
                  required
                />
              ...
              <div className="input-field col s12">
                <input
                  ...
                  type="text"
                  className="validate"
                  value={this.state.author2}
                  onChange={event => this.handleFormChange(event, "author2")}
                />
              ...
              <div className="input-field col s12">
                <input
                  ...
                  onChange={event => this.handleFormChange(event, "ccli")}
                />
              ...
              <div className="input-field col s12">
                <input
                  ...
                  onChange={event => this.handleFormChange(event, "copyDate")}
                />
              ...
              <div className="input-field col s12">
                <input
                  ...
                  onChange={event => this.handleFormChange(event, "publisher")}
                />
              ...
              <div className="input-field col s12">
                <input
                  ...
                  type="text"
                  className="validate"
                  value={this.state.songOrder}
                  onChange={event => this.handleFormChange(event, "songOrder")}
                />
